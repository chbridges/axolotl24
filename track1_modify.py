...
def parse_args():
    ...
    arg("--cluster_algorithm", help = "name of cluster_algorithm", choices=['ap','DBSCAN'],default='ap')
...
def get_sentence_embeddings(outputs: ModelOutput, arguments: argparse.Namespace):
...
def find_target_id(example: str, target: str, orth: str):
...
def find_token_id(inputs: BatchEncoding, batch_id: int, target_id: int):
